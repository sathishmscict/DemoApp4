...
public class FragmentHome extends android.support.v4.app.Fragment {
 ...
 /* For this injection you have to specify the source of the views */
    ...
    private void getAllRestaurantDetailsFromServer() {
        ...
        Log.d(TAG, "URL api/restros/getRestros : " + CommonMethods.WEBSITE + "api/restros/getRestros?body=" + restaurantDataRequest.toString());
    ...
    private void getPopularRestarantsDetailsFromServer() {
        ...
        Log.d(TAG, "URL api/restros/getPopularRestros : " + CommonMethods.WEBSITE + "api/restros/getPopularRestros?body=" + restaurantDataRequest.toString());
